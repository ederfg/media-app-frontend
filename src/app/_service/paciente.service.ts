...
export class PacienteService extends GenericService<Paciente> {
  ...
  returnpaciente(paciente:Paciente){
    return this.http.post<Paciente>(`${this.url}/returnpaciente`,paciente);
  }
  ...
  //set Subjects
  setPacienteCambio(medicos: Paciente[]) {
    this.pacienteCambio.next(medicos);
  }
